...
// Route::get('/email_templates/kemedar/{lang}', 'FrontendController@viewEmail')->name('viewEmail');
Route::get('/email_templates/kemedar/{page}', 'FrontendController@showStaticPage');
Route::group(['middleware' => ['guest']], function () {
    Route::get('register/{sponsor?}', 'Auth\RegisterController@sponsor')->name('register.sponsor');
});

// Route::group(['middleware' => ['guest']], function () {
//     Route::get('active-account', 'Auth\RegisterController@sponsor')->name('register.sponsor');
// });

Route::get('/catalogues/{slug}', 'FrontendController@flipBook')->name('flipBook');



Route::group(['middleware' => ['auth'], 'prefix' => 'founder', 'as' => 'founder.'], function () {
    Route::middleware('userCheck')->group(function () {
        Route::middleware('kyc')->group(function () {
            //Route::group(['middleware' => ['role:founder|investor|admin']], function () {
                Route::get('/dashboard', 'FundController@dashboard')->name('fundDashboard');
                Route::get('/my-investors', 'FundController@myInvestors')->name('myInvestors');
...
Route::group(['middleware' => ['auth']], function () {
    Route::middleware('userCheck')->group(function () {
        Route::middleware('kyc')->group(function () {
            Route::post('/add-project-to-list', 'AjaxController@addListProject')->name('addProjectToList');
            Route::post('/add-investor-to-list', 'AjaxController@addListInvestor')->name('addInvestorToList');
            Route::get('/investor-shortlist', 'CustomFrontendController@investorShortList')->name('investorShortList');
            Route::get('/project-shortlist', 'CustomFrontendController@projectShortList')->name('projectShortList');
            Route::get('/mylist', 'CustomFrontendController@mylist')->name('myList');

            Route::match(['post'], '/load-mylist', 'CustomFrontendController@loadMylistAjax')->name('loadMylistAjax');

            Route::get('/submit-newsfeed', 'CustomFrontendController@submitNewsfeed')->name('submitNewsfeed');
...
Route::match(['get', 'post'], '/investor-search', 'CustomFrontendController@investorSearch')->name('investorSearch');
Route::match(['get'], '/entrepreneurs-faq', 'CustomFrontendController@entrepreneursFaqsPage')->name('entrepreneursFaqsPage');
Route::match(['get'], '/investors-faq', 'CustomFrontendController@investorsFaqsPage')->name('investorsFaqsPage');
Route::match(['get'], '/faq-page', 'CustomFrontendController@faqsPage')->name('faqsPage');
Route::match(['get'], '/about-us', 'CustomFrontendController@aboutUs')->name('aboutUs');
Route::match(['get'], '/privacy-policy', 'CustomFrontendController@privacy')->name('privacy');
Route::match(['get'], '/term-policies', 'CustomFrontendController@termPolicies')->name('termPolicies');
Route::match(['get'], '/invest-method', 'CustomFrontendController@investMethod')->name('investMethod');
Route::match(['get'], '/investor-terms', 'CustomFrontendController@investorTerms')->name('investorTerms');
Route::match(['get'], '/investment-strategies', 'CustomFrontendController@investmentStrategies')->name('investmentStrategies');


Route::get('/newsfeed', 'CustomFrontendController@newsfeed')->name('newsFeed');

Route::post('check-number-token', 'AjaxController@checkNumberToken')->name('checkNumberToken');
Route::post('load-video', 'AjaxController@ajaxLoadSpeed')->name('ajaxLoadSpeed');
...
Route::group(['middleware' => ['auth'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::middleware('userCheck')->group(function () {
        Route::middleware('kyc')->group(function () {
            ...
            Route::get('/create-project', 'ProjectController@createProject')->name('createProject');

            Route::get('/edit-project/{slug}', 'ProjectController@editProject')->name('editProject');



            Route::get('project-search', 'ProjectController@search')->name('searchProject');

            // delete project
            Route::post('delete-project', 'AjaxController@deleteUserProjectRow')->name('deleteProject');

            // chat module


            Route::post('make-withdraw', 'AjaxController@createWithdrawRequest')->name('createWithdrawRequest');
            ...
            Route::get('/transaction-history', 'User\HomeController@transactionHistory')->name('transactionHistory');
            Route::get('/withdraw', 'User\HomeController@withdraw')->name('withdraw');
            Route::get('/withdraw-history', 'User\HomeController@withdrawHistory')->name('withdrawHistory');
            ...
            //Project
            Route::get('user-projects', 'ProjectController@userProject')->name('projects');

            //Route::get('user-projects', 'ProjectController@index')->name('projects');
            Route::get('pending-projects', 'ProjectController@pendingUserProject')->name('pending.projects');
        ...
        Route::post('/investor-info', 'User\HomeController@investorInfo')->name('investorInfo');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin','permission']], function () {
        ...
        // create crud module for admin
        Route::get('/category', 'Admin\BackendController@categoryIndex')->name('category');
        Route::post('/create-category', 'Admin\AjaxController@createCategory')->name('createCategory');
        Route::post('/edit-category', 'Admin\AjaxController@editCategory')->name('editCategory');
        Route::post('/delete-category', 'Admin\AjaxController@deleteCategory')->name('deleteCategory');


        // faq module
        Route::post('/delete-faq', 'Admin\AjaxController@deleteFaqContent')->name('deleteFaqContent');
        Route::post('/edit-faq', 'Admin\AjaxController@saveEditFaqContent')->name('saveEditFaqContent');
        Route::post('/get-faq', 'Admin\AjaxController@getFaqContent')->name('getFaqContent');
        Route::post('/create-faq', 'Admin\AjaxController@createFaqContent')->name('createFaqContent');
        ...
        // translate system
        Route::match(['get', 'post'], 'import/translation', 'Admin\SystemTranslationController@importCSVFile')->name('importCSVFile');
        Route::get('export/translation', 'Admin\SystemTranslationController@exportCsvFile')->name('export.language.csv');
        //Route::post('translation/import', 'importCSVFile')->name('app-translations.import');

        // manage project
        // create crud module for admin
        Route::get('/manage-project/{slug}', 'Admin\BackendController@manageProject')->name('manageProject');
        Route::post('/create-module/{slug}', 'Admin\AjaxController@createModule')->name('createModule');
        Route::post('/edit-module/{slug}', 'Admin\AjaxController@editModule')->name('editModule');
        Route::post('/delete-module/{slug}', 'Admin\AjaxController@deleteModule')->name('deleteModule');

        Route::get('/manage-newsfeed', 'Admin\BackendController@manageNewsfeed')->name('manageNewsfeed');
        ...
        Route::post('delete-admin-project', 'AjaxController@deleteProjectRow')->name('deleteProject');
        ...
        Route::get('admin-projects', 'ProjectController@adminProject')->name('projects');



        Route::get('clone-project/{id}', 'ProjectController@cloneProject')->name('cloneProject');

        Route::get('pending-projects', 'ProjectController@pendingProject')->name('pendingProjects');
        Route::post('set-featured-project', 'ProjectController@setFeatured')->name('setFeaturedProject');
        ...
        Route::get('/view-withdraw', 'Admin\ManagePlanController@viewWithdraw')->name('viewWithdraw');
        Route::post('/approve-withdraw', 'Admin\ManagePlanController@approveWithdraw')->name('approveWithdraw');


        Route::post('delete-plan', 'Admin\ManagePlanController@deletePlan')->name('deletePlan');

        // xeedwallet
        Route::get('/xeedwallet-list', 'Admin\BackendController@xeedwalletList')->name('xeedwalletList');
        Route::get('/create-xeedwallet', 'Admin\BackendController@createXeedwallet')->name('createXeedwallet');
        Route::post('/submit-xeedwallet', 'Admin\BackendController@submitXeedwalletUser')->name('submitXeedwalletUser');

        Route::post('view-xeedwallet', 'Admin\BackendController@viewXeedwallet')->name('viewXeedwallet');
        Route::post('set-xeedwallet', 'Admin\BackendController@setXeedwallet')->name('setXeedwallet');
        ...
        Route::post('/near-api', 'Admin\ManagePlanController@nearTokenAPI')->name('near-api');


        Route::get('/send-token/{id}', 'Admin\ManagePlanController@sendTokenView')->name('sendToken');

        Route::post('/send-token-on-near', 'Admin\ManagePlanController@sendTokenAjax')->name('sendTokenAjax');

        Route::get('/mint-token/{id}', 'Admin\ManagePlanController@mintTokenView')->name('mintTokenView');

        Route::post('/mint-token-on-near', 'Admin\ManagePlanController@mintToken')->name('mintToken');




        // faq module
        Route::get('/faq-content', 'Admin\BackendController@faqContent')->name('faqContent');

        Route::post('/project-active', 'ProjectController@activeMultipleProject')->name('project-active');
        Route::post('/project-inactive', 'ProjectController@inActiveMultipleProject')->name('project-inactive');
        ...
        /*====Manage Users ====*/
        Route::get('/pending-users/{type}', 'Admin\UsersController@pendingUsers')->name('pendingUsers');
        Route::get('/import-users/{type}', 'Admin\UsersController@importUsers')->name('importUsers');
        Route::get('/kyc-users/{type}', 'Admin\UsersController@kycUsers')->name('kycUsers');
                // Route::get('/users/search/{type}', 'Admin\UsersController@search')->name('users.search');

        Route::get('/users/search', 'Admin\UsersController@search')->name('users.search');
        Route::get('/users/{type}', 'Admin\UsersController@getUsers')->name('typeUsers');
        ...
        Route::post('template/{section}/{language}', 'Admin\TemplateController@update')->name('template.update');
        ...
        Route::post('content-update/{content}/{language?}', 'Admin\ContentController@update')->name('content.update');
...
Route::get('/currency/{code?}', 'FrontendController@currency')->name('currency');
Route::get('/country/{code?}', 'FrontendController@country')->name('country');
...
// investor
Route::get('/investor/{id}', 'CustomFrontendController@viewInvestor')->name('viewInvestor');

// project

Route::get('/project/{slug}', 'FrontendController@viewProject')->name('viewProject');
Route::match(['get', 'post'],'/search-project', 'FrontendController@searchProject')->name('searchProject');



// paymoney
Route::get('/paymoney/{slug}/{price}/{client?}/{secret?}', 'PayMoneyController@payMoneyPayment')->name('payMoneyPayment');
// paymoney cancel
Route::get('/paymoney/cancel', 'PayMoneyController@payMoneyCancel')->name('payMoneyCancel');
// paymoney
Route::get('/done-payment/success/{id}/{amount}', 'PayMoneyController@payMoneySuccess')->name('payMoneySuccess');

// active account by phone
Route::get('/active-account/{slug}', 'CustomFrontendController@activeAccountLayout')->name('activeAccountLayout');
Route::get('/active-account', 'CustomFrontendController@newActiveAccount')->name('newActiveAccount');

Route::post('/send-otp-email', 'AjaxController@sendOtpEmailVerify')->name('sendOtpEmailVerify');

Route::post('/send-otp-phone', 'AjaxController@sendCodeToPhone')->name('sendOtpPhoneVerify');

Route::post('/submit-active', 'AjaxController@activeAccount')->name('activeAccount');

Route::get('auth/twitter', 'SocialController@redirectTwitterToProvider')->name('twitter');
Route::get('auth/twitter/callback', 'SocialController@handleTwitterCallback');

Route::get('auth/linkedin', 'SocialController@linkedinRedirect')->name('linkedin');
Route::get('auth/linkedin/callback', 'SocialController@linkedinCallback');
...
Route::post('/pagination-gallery', 'FrontendController@imagePagination')->name('imagePagination');
Route::post('/pagination-video', 'FrontendController@videoPagination')->name('videoPagination');

// create folder
Route::get('/create-folder', 'FrontendController@createFolder')->name('createFolder');
