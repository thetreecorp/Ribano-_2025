...
class SocialController extends Controller
{
    ...
    public function linkedinCallback() {
        ...
        try {
           ...
           // dd( $data );
            ...
            if(($data)) {
                ...
                if (!$user) {
                    ...
                    if($userCreate) {
                        ...
                        return back()->withErrors(['authentication_deny' => 'Login with linkedin failed. Error with create user.']);
                    }
            ...
            return back()->withErrors(['authentication_deny' => 'Login with linkedin failed. Please try again.']);
    ...
    public function handleProviderCallback(string $provider)
    {
        ...
        if ($session->get('redirect_uri')) {
            ...
            $redirect_uri = url('/user/dashboard');
            if(isset($_GET['redirect_uri']) && $_GET['redirect_uri']) {
                $redirect_uri = $_GET['redirect_uri'];
                $session->set('redirect_uri', $redirect_uri);
            }
