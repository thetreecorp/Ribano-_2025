...
class Testimonial extends CI_Controller {
	...
	{  
        ...
        ******************************/
        ...
        $config["total_rows"] = $this->db->get_where('web_article', array('data_key',"testimonial"))->num_rows();
        $config["per_page"] = 25;
        ...
        ******************************/
		...
		$data['content'] = $this->load->view("backend/article/testimonial_list", $data, true);
	...
	public function form($article_id = null)
	{
		...
		$this->form_validation->set_rules('headline_en', 'Name','required|max_length[255]|xss_clean');

		$data['article']   = (object)$userdata = array(
			'article_id'      	=> $this->input->post('article_id',TRUE),
			'data_key'			=> 'testimonial',
			'video'   			=> $this->input->post('headline_en',TRUE),
			'custom_data' 		=> $this->input->post('article1_en',TRUE),
			'article_data' 		=> $this->input->post('article2_en',TRUE),
