...
class Social_link extends CI_Controller {
	...
	{ 
		...
		$this->form_validation->set_rules('link', display('link'),'required|max_length[100]|xss_clean');
		$this->form_validation->set_rules('icon', display('icon'),'required|max_length[100]|xss_clean');
