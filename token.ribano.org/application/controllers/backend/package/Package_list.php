...
class Package_list extends CI_Controller {
	...
	{  
		...
		$data['userrole'] = $this->common_model->getMenuSingelRoleInfo(18);
 		#-------------------------------#
        #
        #pagination starts
        #
        $config["base_url"] = base_url('backend/package/package_list');
        ...
        #pagination ends
        #    
		$data['content'] = $this->load->view("backend/package/package_list", $data, true);
	...
	{  
		...
		redirect("backend/package/package_list");
	}
