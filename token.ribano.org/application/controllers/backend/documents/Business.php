...
class Business extends CI_Controller {
    ...
    {
        $data['title']   = display('business_doc');
        $data['userrole'] = $this->common_model->getMenuSingelRoleInfo(14);
        $data['level']   = "business";
        $data['documents'] = $this->documents->getDocuments('business');
        ...
        if($this->form_validation->run()){
            ...
            if($uploadimg !== false && $uploadimg != null)
            {
                ...
                if($check->num_rows()){
                    ...
                    redirect('backend/documents/business/form');
                }
    ...
    public function delete($id="")
    {
        ...
        redirect('backend/documents/business');
    }
