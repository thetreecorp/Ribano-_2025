...
class Message extends CI_Controller 
{
    ...
    {   
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('shareholder/message/index');
        ...
        #pagination ends
        #  
        $data['content'] = $this->load->view('shareholder/email_sms/all_message', $data, true);
    ...
    {   
        ...
        $data['title']   = display('message'); 
        $data['content'] = $this->load->view('shareholder/email_sms/sms_details', $data, true);
        $this->load->view('shareholder/layout/main_wrapper', $data);  
    }
