...
class Notification extends CI_Controller 
{
    ...
    {   
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('shareholder/notification/index');
        ...
        $data['content'] = $this->load->view('shareholder/email_sms/email_notification', $data, true);
    ...
    {   
        ...
        $data['title']   = display('notification'); 
        $data['content'] = $this->load->view('shareholder/email_sms/email_details', $data, true);
        $this->load->view('shareholder/layout/main_wrapper', $data);  
    }
