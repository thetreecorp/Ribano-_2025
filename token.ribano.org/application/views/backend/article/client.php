            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', html_escape($article->article_id)) ?> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="headline_en" value="<?php echo htmlspecialchars_decode($article->headline_en) ?>" class="form-control" placeholder="<?php echo display('client') ?>" type="text" id="headline_en">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="article1_en" value="<?php echo htmlspecialchars_decode($article->article1_en) ?>" class="form-control" placeholder="<?php echo display('link') ?>" type="text" id="article1_en">
                        </div>
                    </div>
                    <div class="form-group row">
