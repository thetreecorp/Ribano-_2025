            ...
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <div class="col-sm-3 col-md-3 pull-right">
                        <a class="btn btn-success w-md m-b-5 pull-right" href="<?php echo base_url("backend/cms/".$this->uri->segment(3)."/form") ?>"><i class="fa fa-plus" aria-hidden="true"></i> Add Team</a>
                    </div>
                </div>
            </div>
                ...
                <table class="datatable2 table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $value->cat_id==1?"Leader Ship":"Team Member"; ?></td>
