            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', html_escape($article->article_id)) ?> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="headline_en" value="<?php echo htmlspecialchars_decode($article->headline_en) ?>" class="form-control" placeholder="<?php echo display('headline_en') ?>" type="text" id="headline_en">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="headline_fr" value="<?php echo htmlspecialchars_decode($article->headline_fr) ?>" class="form-control" placeholder="<?php echo display('headline')." ".html_escape($web_language->name) ?>" type="text" id="headline_fr">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea  id="summernote" name="article1_en" class="form-control editor" placeholder="<?php echo display('article_en') ?>" type="text" id="article1_en"><?php echo htmlspecialchars_decode($article->article1_en) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 col-form-label"><?php echo display('article')." ".html_escape($web_language->name) ?></label>
                        <div class="col-sm-10">
                            <textarea   id="summernote1" name="article1_fr" class="form-control" placeholder="<?php echo display('article')." ".html_escape($web_language->name) ?>" type="text" id="article1_fr"><?php echo htmlspecialchars_decode($article->article1_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article2_en" class="col-sm-2 col-form-label"><?php echo display('article_en') ?></label>
                        <div class="col-sm-10">
                            <textarea  id="summernote2" name="article2_en" class="form-control editor" placeholder="<?php echo display('article_en') ?>" type="text" id="article2_en"><?php echo htmlspecialchars_decode($article->article2_en) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article2_fr" class="col-sm-2 col-form-label"><?php echo display('article')." ".html_escape($web_language->name) ?></label>
                        <div class="col-sm-10">
                            <textarea   id="summernote3" name="article2_fr" class="form-control" placeholder="<?php echo display('article')." ".html_escape($web_language->name) ?>" type="text" id="article2_fr"><?php echo htmlspecialchars_decode($article->article2_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
