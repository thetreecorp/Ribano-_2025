            ...
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <div class="col-sm-3 col-md-3 pull-right">
                        <a class="btn btn-success w-md m-b-5 pull-right" href="<?php echo base_url("backend/cms/".$this->uri->segment(3)."/form") ?>"><i class="fa fa-plus" aria-hidden="true"></i> Add FAQ</a>
                    </div>
                </div>
            </div>
                ...
                <table class="datatable2 table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $value->cat_id==1?display('regular_question'):($value->cat_id==2?display('clients_question'):display('trending_question')); ?></td>
