            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('id', html_escape($advertisement->id)) ?> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="name" value="<?php echo html_escape($advertisement->name); ?>" class="form-control" type="text" id="name" placeholder="<?php echo display('name') ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control basic-single" name="page">
                                ...
                                <?php foreach ($parent_cat as $key => $value) { ?>
                                    <option value="<?php echo html_escape($value->cat_id); ?>" <?php echo ($advertisement->page==$value->cat_id)?'Selected':'' ?>><?php echo html_escape($value->slug); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <span id="add_content_load">
                        ...
                        <div class='form-group row'>
                            <label for='image' class='col-sm-4 col-form-label'><?php echo display("image") ?> (MAX 2MB)</label>
                            <div class='col-sm-8'>
                        ...
                        <div class='form-group row'>
                            ...
                            <div class='col-sm-8'>
                                <input name='url' value='<?php echo html_escape($advertisement->url) ?>' class='form-control' placeholder='<?php echo display('url') ?>' type='text' id='url'>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class='form-group row'>
                            ...
                            <div class='col-sm-8'>
                                <textarea  name='script' class='form-control' placeholder='<?php echo display('embed_code') ?>' type='text' id='script'><?php echo htmlspecialchars_decode($advertisement->script) ?></textarea>
                            </div>
                        </div>
                        <?php } ?>
