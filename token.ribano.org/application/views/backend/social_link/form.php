    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('id', html_escape($social_link->id)) ?> 
                    <div class="form-group row">
                        <label for="name" class="col-sm-4 col-form-label"><?php echo display("name") ?></label>
                        <div class="col-sm-8">
                            <input name="name" value="<?php echo html_escape($social_link->name) ?>" class="form-control" type="text" id="name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="link" class="col-sm-4 col-form-label"><?php echo display("link") ?></label>
                        <div class="col-sm-8">
                            <input name="link" value="<?php echo html_escape($social_link->link) ?>" class="form-control" type="text" id="link">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="icon" class="col-sm-4 col-form-label"><?php echo display("icon") ?></label>
                        <div class="col-sm-8">
                            <input name="icon" value="<?php echo html_escape($social_link->icon) ?>" class="form-control" type="text" id="icon">
                        </div>
                    </div> 
                    <div class="form-group row">
