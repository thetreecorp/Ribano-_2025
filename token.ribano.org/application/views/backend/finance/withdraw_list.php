                ...
                <div class="">
                    <table class="datatable2 table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a><?php echo html_escape($value->user_id); ?></a></td>
                                ...
                                <td>
                                 ...
                                 <td>
                                    ...
                                    <?php } ?>
                                     ...
                                     <a href="#<?php echo $value->user_id;?>" class="AjaxModal btn btn-info btn-sm" data-toggle="modal" data-target="#newModal"> <?php echo display('information'); ?></a>
                                 </td>
