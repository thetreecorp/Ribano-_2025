    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('ext_exchange_wallet_id', html_escape($exchange_wallet->ext_exchange_wallet_id)) ?>
                        ...
                        <div class="col-sm-8">
                            <select class="form-control basic-single" name="cid" id="cid">
                                ...
                                <?php foreach ($currency as $key => $value) { ?>
                                    <option value="<?php echo html_escape($value->cid); ?>" <?php echo ($exchange_wallet->coin_id==$value->cid)?'Selected':'' ?> ><?php echo html_escape($value->name); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="wallet_data" value="<?php echo html_escape($exchange_wallet->wallet_data) ?>" class="form-control" type="text" id="wallet_data" placeholder="<?php echo display('wallet_data') ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="sell_adjustment" class="col-sm-4 col-form-label"><?php echo display('sell_adjustment') ?> %</label>
                        <div class="col-sm-8">
                            <input name="sell_adjustment" value="<?php echo html_escape($exchange_wallet->sell_adjustment) ?>" class="form-control" type="text" id="sell_adjustment" placeholder="<?php echo display('sell_adjustment') ?> %">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="buy_adjustment" class="col-sm-4 col-form-label"><?php echo display('buy_adjustment') ?> %</label>
                        <div class="col-sm-8">
                            <input name="buy_adjustment" value="<?php echo html_escape($exchange_wallet->buy_adjustment) ?>" class="form-control" type="text" id="buy_adjustment" placeholder="<?php echo display('buy_adjustment') ?> %">
                        </div>
                    </div> 
                    <div class="form-group row">
