            ...
            <div class="panel-body"  id="printableArea">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        <h1 class="m-t-0"><?php echo display('commission_no'); ?> : <?php echo $this->uri->segment(4)?></h1>
                    ...
                    <table class="table table-border table-bordered ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo html_escape($my_commission->first_name).' '. html_escape($my_commission->last_name);?></td>
                            </tr>
                            <tr>
                                <th><?php echo display('package_name');?></th>
                                <td><?php echo html_escape($my_commission->package_deatils);?></td>
                            </tr>
                            <tr>
