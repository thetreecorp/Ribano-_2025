                ...
                <table class="table table-bordered table-hover font-size-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo !empty($value->crypto_rate1)?html_escape($value->crypto_rate1):html_escape($value->crypto_rate) ?></td>
                            <td><?php echo !empty($value->complete_qty1)?html_escape($value->complete_qty1):html_escape($value->complete_qty) ?></td>
                            <td><?php echo !empty($value->available_qty1)?html_escape($value->available_qty1):html_escape($value->available_qty) ?></td>
                            ...
                            <td><a href="<?php echo base_url("shareholder/exchange/exchange_cancel/$value->id") ?>" class="btn btn-danger btn-xs" title="Cancel">Cancel</a></td>
                        </tr>
                        <?php html_escape($sl++); } ?>                    
                    </tbody>
                </table>
