                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                        <div class="border_preview">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo html_escape($coininfo->pair_with); ?> <?php echo html_escape($data->amount);?></td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="text-right">
                                <button type="button" id="confirm_transfer_btn" class="btn btn-success w-md m-b-5"><?php echo display('confirm'); ?></button>
