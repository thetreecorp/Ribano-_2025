        ...
        <div class="card-body">
            ...
            <div class="media mb-4 justify-content-between">
                ...
                @if(adminAccessRoute(config('role.manage_plan.access.add')))
                    <a href="{{route('admin.createXeedwallet')}}" class="btn btn-sm  btn-primary mr-2">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tr>
                        ...
                        <th scope="col">@lang('clien Id')</th>
                        <th scope="col">@lang('Secret')</th>
                      
                    </tr>
                    </thead>
                    <tbody>
                    @forelse($manageWallet as $item)
                        <tr>
                            ...
                            <td data-label="@lang('Password')">
                                <p class="font-weight-bold">{{$item->password}}</p>
                            </td>

                            <td data-label="@lang('clien Id')">
                                <?php echo $item->client_id; ?>
                            </td>
                            <td data-label="@lang('Secret')">
