                                        ...
                                        <form method="post"
                                            ...
                                            @if($content->name == 'faq')
                                                    @if($categories)
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="{{ trans('Category') }}"> {{trans('Category')}} </label>
                                                                <select class="form-control" name="category_id">
                                                                    <option value="0">{{trans("Select category")}}</option>
                                                                    @foreach ( $categories as $category)
                                                                        <option <?php echo (isset($contentDetails[$language->id][0]->category_id) == $category->id ? 'selected' : '') ?> value="{{$category->id}}">{{$category->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
