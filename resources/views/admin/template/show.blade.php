                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            // dd(config("templates.$section.field_name"));
                        ?>
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}" role="tabpanel">
                                    <form method="post" action="{{ route('admin.template.update', [$section,$language->id]) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 source-parent">
                                                <?php 
                                                   // dd(getFile(config('location.template.path').(isset($templateMedia->image_2_option) ? $templateMedia->image_2_option : '')));
                                                ?>
                                                <div class="form-group">
                                                    <label for="image"> Image </label>
                                                    <div class="image-input ">
                                                        <label for="image-upload" id="image-label"><i class="fas fa-upload"></i></label>
                                                        <input type="file" placeholder="Choose image" class="image-preview" id="image-option" name="image_option_2">
                                                        @if(isset($templateMedia->image_2_option))
                                                            <img id="" class="preview-image"
                                                                src="{{getFile(config('location.template.path').(isset($templateMedia->image_2_option) ? $templateMedia->image_2_option : ''))}}" alt="preview image">
