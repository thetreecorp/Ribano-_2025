...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            @if ($status)
                <form id="send_token_frm" method="post" action="{{route('admin.mintToken')}}" class="form-row justify-content-center">
                    @csrf
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p> Total Token for this account: <span style="color: red">{{$total_token}}</span> {{$token_symbol}}</p>
                            </div>

                            <div class="col-md-12">
                                <label>@lang('Mint Token')</label>
                                <input type="number" min="1" max="{{$total_token}}" id="number_token" name="mint_tk_input" value="" class="form-control">
                            </div>
    
    
                            <input type="hidden" id="token_symbol" value="{{$token_symbol}}">
                        </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.code == '400')
                        ...
                        showToastV2('Token minted', 1000, 'success');
                        location.reload();
