                ...
                <div class="col-lg-6 order-2 order-lg-1">
                    <div class="section_content">
                        <div class="section_header">
                            ...
                            <div class="short_description">@lang(@$aboutUs->description->short_description)</div>
                        </div>
                        <div class="button_area">
                            <a class="custom_btn mt-30 top-right-radius-0" href="{{ route('investmentStrategies') }}">@lang('Learn more')</a>
                        </div>
                    </div>
                </div>
