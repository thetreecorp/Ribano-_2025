...
<div id="sidebar" class="">
    ...
    <div class="wallet-wrapper">
        <div class="wallet-box d-none d-lg-block">
            ...
            <h5> @lang('Total Invest') <span>{{ $basic->currency_symbol }}{{ @$user->total_invest() }}</span></h5>
    ...
    <nav class="sidebar-nav">
        <ul class="main tabScroll" id="sidebarnav">
            ...
            <li>
                <a href="{{route('searchProject')}}" class="sidebar-link {{menuActive(['searchProject'])}}" 
                href="{{route('searchProject')}}"><i class="fal fas fa-search"></i>{{@translate('Explore Projects')}}</a>
            </li>
            </hr>
            {{-- <li>
            ...
            <li>
                <a href="{{route('user.transactionHistory')}}" class="sidebar-link {{menuActive(['user.transactionHistory'])}}">
                    <i class="far fa-sack-dollar"></i> {{trans('Transactions history')}}
                </a>
            </li>
            ...
            <li>
                <a href="{{route('user.withdraw')}}" class="sidebar-link {{menuActive(['user.withdraw'])}}">
                    <i class="far fa-sack-dollar"></i> {{trans('Withdraw')}}
                </a>
            </li>
            <li>
                <a href="{{route('user.withdrawHistory')}}" class="sidebar-link {{menuActive(['user.withdrawHistory'])}}">
                    <i class="far fa-sack-dollar"></i> {{trans('Withdraw history')}}
                </a>
            </li>
