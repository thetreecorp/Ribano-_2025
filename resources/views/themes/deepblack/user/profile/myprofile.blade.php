            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="upload-img">
                    <form method="post" action="{{ route('user.updateProfile') }}" enctype="multipart/form-data">
                        ...
                        <h3 class="golden-text">@lang(ucfirst($user->username)) <sup><sapn class="badge badge-pill bg-outline-success badge_lavel_style text-white">{{ @$user->rank->rank_lavel }}</sapn></sup> </h3>
            ...
            <div class="col-lg-8">
                <div class="edit-area">
                    <div class="profile-navigator">
                        ...
                        <button tab-id="tab2" class="golden-text tab {{ $errors->has('password') ? 'active' : '' }}">
                            @lang('Password Setting')
                        </button>
                        <button tab-id="tab3" class="golden-text tab {{ $errors->has('identity') ? 'active' : '' }}">
