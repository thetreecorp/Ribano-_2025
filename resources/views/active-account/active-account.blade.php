...
<div class="active-wrap">
    <div class="container">
        <div class="active-option ">
            <div class="col-lg-8 mx-auto col-md-8">
                <input type="checkbox" id="activeByEmail" />
                <label for="activeByEmail">Active by email</label>
            </div>
        </div>
    </div>
    
    
    <div class="login_signup_area phone-active">
        <div class="container">
    ...
    <div class="login_signup_area email-active" style="display: none">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 mx-auto col-md-8">
                    <div class="login_signup_form p-4">
                        ...
                        <form id="frm-email-active" action="{{route("activeAccount")}}" method="post">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="email_otp_code" class="form-control" placeholder="{{@translate('Otp')}}">
                                <span class="input-group-text" id="basic-addon2"><i class="fa-solid fa-lock"></i></span>
                            </div>
