            ...
            <div class="chat-coversation right">
                <div class="media">
                    ...
                    <span class="avatar avatar-xs flex-shrink-0">
                        {{-- <img @if ($chat->sender->image != null) src="{{ getFile(config('location.user.path').$chat->sender->image) }}" @endif> --}}
                        @if ($chat->sender->image != null)
                            <img src="{{ getFile(config('location.user.path').$chat->sender->image) }}">
                        @else
                                    ...
                                    @if ($attachment->type == 'image')
                                        <div class="mb-2 file-preview-item" title="{{ $attachment->file_name }}">
                                            <a href="{{ route('download_attachment', $attachment->id) }}" target="_blank" class="d-block">
                                                <div class="thumb">
                                                    <img src="{{ my_asset_file($attachment->file_name) }}" class="img-fit">
                                                </div>
                                                <div class="body">
                                                    <h6 class="d-flex">
