                  ...
                  <div class="collapse navbar-collapse" id="navbar-content-search">
                    <form id="seach-project-form" class="d-flex search-form" method="post" action="">
                        <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                                ...
                                <div class="dropdown-menu shadow">
                                    <div class="mega-content px-4">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <p>
                                                    <label for="amount"><?php echo e(translate('Show projects between')); ?>:</label>
                            ...
                            <li class="nav-item dropdown dropdown-mega position-static">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside"><?php echo e(translate('Country')); ?></a>
                                <div class="dropdown-menu shadow">
                                    <div class="mega-content px-4">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="countries-top">
                                                    <a class="clear-countries-option" href="javascript:void(0)" > <?php echo e(translate('Clear')); ?></a>
                                                ...
                                                <div class="countries-wrap scroll-div row">
                                                    ...
                                                    <?php $__currentLoopData = config('country'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="form-row col-lg-4 col-md-4 col-sm-4">
                                                            <input name="countries[]" class="form-check-input" type="checkbox" value="<?php echo e($value['name']); ?>">
                                                            <label class="form-check-label" for="flexCheckDefault">
                            ...
                            <li class="nav-item dropdown dropdown-mega position-static">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside"><?php echo e(translate('Industry')); ?></a>
                                <div class="dropdown-menu shadow">
                                    <div class="mega-content px-4">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="location-top">
                                                    <a class="clear-industries-option" href="javascript:void(0)" > <?php echo e(translate('Clear')); ?></a>
                                                ...
                                                <div class="industries-wrap scroll-div row">
                                                    ...
                                                    <?php $__currentLoopData = $common->getIndustries(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="form-row col-lg-4 col-md-4 col-sm-4">
                                                            <input name="industries[]" class="form-check-input" type="checkbox" value="<?php echo e($value->id); ?>">
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                <?php echo e($value->name); ?>
                            ...
                            <li class="nav-item dropdown dropdown-mega position-static">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside"><?php echo e(translate('Stages')); ?></a>
                                <div class="dropdown-menu shadow">
                                    <div class="mega-content px-4">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="stages-top">
                                                    <a class="clear-stages-option" href="javascript:void(0)" > <?php echo e(translate('Clear')); ?></a>
                                                ...
                                                <div class="stages-wrap scroll-div row">
                                                    ...
                                                    <?php $__currentLoopData = $common->getStages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                                            <input name="stages[]" class="form-check-input" type="checkbox" value="<?php echo e($value->id); ?>">
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                <?php echo e(htmlspecialchars_decode($value->name)); ?>
                            ...
                            <li class="nav-item dropdown dropdown-mega position-static">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside"><?php echo e(translate('Funding Type')); ?></a>
                                <div class="dropdown-menu shadow">
                                    <div class="mega-content px-4">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="location-top">
                                                    <a class="clear-funding-option" href="javascript:void(0)" > <?php echo e(translate('Clear')); ?></a>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="flexCheckDefault">
                                                        <?php echo e(translate('SAFE convertible notes')); ?>
                            ...
                            <li class="nav-item dropdown dropdown-mega">
                                <a class="nav-link dropdown-toggle clear-all-cb" href="javascript:void(0)" ><?php echo e(translate('Clear filters')); ?></a>
                            </li>
                        </ul>
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-primary border-0" type="submit"><?php echo e(translate('Search')); ?></button>
                        </div>
                    </form>
                  </div>
                </div>
    ...
    <section class="content-search">
            ...
            <div class="container">
                <div class="top-title-project text-center">
                    <h6 class=""><?php echo e(translate('Recent Project')); ?></h6>
                    <p class="desc-p"><?php echo e(translate('Find project and investment opportunities worldwide on the Middle East Investment Network and connect with business entrepreneurs, start up companies, established businesses looking for funding')); ?></p>
                </div>
...
<?php $__env->startPush('script'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/simplePagination.js')); ?>"></script>
    <script>
        $( function() {
            $( "#slider-range" ).slider({
              range: true,
        ...
        function ajaxCall($page = 1, $updatePagination = true) {
			$.ajax({
		        ...
		        url: '<?php echo e(route("searchProject")); ?>',
        ...
        pagination(<?php echo e($total); ?>, true);

    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make($theme.'layouts.app', ['body_class' => 'search-project'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\ribano\resources\views/project/search.blade.php ENDPATH**/ ?>