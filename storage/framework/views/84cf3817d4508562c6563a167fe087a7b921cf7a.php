...
<!--[if (gte IE 9)|!(IE)]><!-->
<html class="no-js <?php echo e((getRTL('rtl') == 1) ? 'rtl' : ''); ?>" <?php if(getRTL('rtl') == 1): ?> dir="rtl" <?php endif; ?> >
<head>
    <meta charset="utf-8"/>
...
<body onload="preloder_function()" class="<?php echo e($body_class ?? ''); ?>">
...
<?php echo $__env->make($theme.'partials.convertable_note', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\project\ribano-new-look\resources\views/themes/lightpink/layouts/app.blade.php ENDPATH**/ ?>