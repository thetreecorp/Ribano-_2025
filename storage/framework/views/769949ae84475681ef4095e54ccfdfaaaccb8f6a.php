...
<?php $__env->startSection('content'); ?>
    <div class="p-3">
        <div class="text-center">
            <img style="max-width: 100%" src=" <?php echo e(getFile(config('location.logoIcon.path').'favicon.png')); ?>" alt="wrapkit">
        </div>
...
<?php echo $__env->make('admin.layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\ribano\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>