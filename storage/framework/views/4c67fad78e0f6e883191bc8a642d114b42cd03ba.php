        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <?php if(adminAccessRoute(config('role.manage_plan.access.view'))): ?>
                    ...
                    <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('Manage Projects'); ?></span></li>
                    

                    <li class="sidebar-item <?php echo e(menuActive(['admin.projects'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.projects')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('All Projects'); ?></span>
                        </a>
                    </li>
                    <li class="sidebar-item <?php echo e(menuActive(['admin.pendingProjects'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.pendingProjects')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Pending Projects'); ?></span>
                        </a>
                    </li>
                    <li class="sidebar-item <?php echo e(menuActive(['admin.createProject'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.createProject')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('New Project'); ?></span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i class="fas fa-envelope text-success"></i>
                            <span class="hide-menu"><?php echo e(trans("Manage modules of Projects")); ?></span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.manageProject', 'industry-category')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Industry Category")); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.manageProject', 'project-stage')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Project Stage")); ?> </span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.manageProject', 'ideal-investor-role')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Ideal Investor Role")); ?> </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <?php if(adminAccessRoute(config('role.user_management.access.view'))): ?>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i class="fas fa-envelope text-success"></i>
                            <span class="hide-menu"><?php echo e(trans("All Users")); ?></span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            <li class="sidebar-item">
                            ...
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.typeUsers', 'founders')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Founders")); ?> </span>
                                </a>
                            </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i class="fas fa-envelope text-success"></i>
                            <span class="hide-menu"><?php echo e(trans("Pending users")); ?></span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.pendingUsers', 'investors')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Investors")); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.pendingUsers', 'founders')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Founders")); ?> </span>
                                </a>
                            </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i class="fas fa-envelope text-success"></i>
                            <span class="hide-menu"><?php echo e(trans("Imported users")); ?></span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.importUsers', 'investors')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Investors")); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.importUsers', 'founders')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Founders")); ?> </span>
                                </a>
                            </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i class="fas fa-envelope text-success"></i>
                            <span class="hide-menu"><?php echo e(trans("Pending KYC")); ?></span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.kycUsers', 'investors')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Investors")); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('admin.kycUsers', 'founders')); ?>" class="sidebar-link">
                                    <span class="hide-menu"><?php echo e(trans("Founders")); ?> </span>
                                </a>
                            </li>
                ...
                <?php if(adminAccessRoute(config('role.manage_plan.access.view'))): ?>
                    ...
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('Translation'); ?></span></li>
                   

                    <li class="sidebar-item <?php echo e(menuActive(['admin.importCSVFile'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.importCSVFile')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Import translation'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(adminAccessRoute(config('role.manage_plan.access.view'))): ?>
                    ...
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('Manage Token'); ?></span></li>
                    
                    <li class="sidebar-item <?php echo e(menuActive(['admin.viewWithdraw'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.viewWithdraw')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('View withdraw'); ?></span>
                        </a>
                    </li>

                    <li class="sidebar-item <?php echo e(menuActive(['admin.planCreate'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.planCreate')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Create Token'); ?></span>
                        </a>
                    </li>
                    <li class="sidebar-item <?php echo e(menuActive(['admin.planList'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.planList')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Token List'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if(adminAccessRoute(config('role.manage_plan.access.view'))): ?>
                    ...
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('Xwallet users'); ?></span></li>
                    

                    <li class="sidebar-item <?php echo e(menuActive(['admin.xeedwalletList','admin.createXeedwallet'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.xeedwalletList')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Users List'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(adminAccessRoute(config('role.manage_plan.access.view'))): ?>
                    ...
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('Faq'); ?></span></li>
                    <li class="sidebar-item <?php echo e(menuActive(['admin.category'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.category')); ?>" aria-expanded="false">
                            <i class="fas fa-file-image text-cyan"></i><span
                                class="hide-menu"><?php echo app('translator')->get('Faq category'); ?></span>
                        </a>
                    </li>
                    <li class="sidebar-item <?php echo e(menuActive(['admin.faqContent'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.faqContent')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Faq'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
...
<?php /**PATH D:\project\ribano\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>